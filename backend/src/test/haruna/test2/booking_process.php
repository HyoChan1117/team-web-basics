<?php
    ...
    try {
        ...
        # data & time이 중복이 되면 오류 표시하고 booking.php로 돌아 가기
        

        # data & time이 중복이 없으면 Reservation테이블에 INSERT 하기  
        $rv_sql = "INSERT INTO Reservation (client_id, designer_id, requirement, date, start_at, end_at)
                    VALUES ('$_SESSION[user_id]', '$designer_id', '$requirement', '$date', '$time','10:00')";
